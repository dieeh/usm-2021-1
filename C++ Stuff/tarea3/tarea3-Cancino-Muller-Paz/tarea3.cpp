...
*   int descuento1
******
*   Esta función toma las compras de un cliente y verifica que se apliquen las ofertas
*   para luego retornar un int con el valor de los descuentos que se deben aplicar.
******
* Input:
*   int compras[] : Es un arreglo que contiene los codigos de los productos a comprar.
*   ranuraO ofertas[] : Es un arreglo del hashing que contiene las ofertas.
*   int c_compras : Es un int que contiene la cantidad de compras del cliente.
*   int c_ofertas : Es un int que contiene la cantidad de ofertas.
******
* Returns:
*   int, retorna el valor de los descuentos a aplicar.
*****/
